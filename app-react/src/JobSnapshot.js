            ...
            <div>
        		<div className="panel panel-default">
            		<div className="panel-body">
						...
						<p>Transportation: {this.props.transportation}</p><br/>
						{this.props.isEmployer ? <span> <div> </div> <br/><button type="button" className="btn btn-default text-center" onClick={() => browserHistory.push('/editjob/' + this.props.id)}>Edit</button> 
