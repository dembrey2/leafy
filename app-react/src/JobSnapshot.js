            ...
            <div>
        		<div className="panel panel-default">
            		<div className="panel-body">
						...
						<div>{this.props.transportation ? 'Has Transporation' : 'No Transportation'}</div>
						{this.props.isEmployer ? <span> <div> </div> <br/><button type="button" className="btn btn-default btn-transparent-charcoal text-center" onClick={() => browserHistory.push('/editjob/' + this.props.id)}>Edit</button> 
